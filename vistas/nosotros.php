            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="nosotros.php"><i class="fa fa-users" aria-hidden="true"></i>&nbsp;QUIENES SOMOS</a></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <article class="icono2"><span class="fa-stack fa-5x">
            ...
            <h2 class="color text-center">Responsabilidad</h2>
            <p style="color: #fff;">Siempre a tiempo y con los lineamientos establecidos.</p>
          </div>
        </div>
      </div>
    </div>
